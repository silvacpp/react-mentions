...
| replaceMarkupOnPaste        | boolean                                                 | true           | Any paste event inside the mention range replaces the full markup text with the clipboard data. To allow the browser to replace only the selection inside the mention range, set this prop to `false` |
